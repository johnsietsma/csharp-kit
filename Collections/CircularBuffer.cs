//From: http://circularbuffer.codeplex.com/
...
public class CircularBuffer<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
{
    ...
    {
        if ( capacity < 0 ) {
            throw new ArgumentException( "Capacity is below 0" );
        }
    ...
    public int Capacity
    {
        ...
        set {
            ...
            if ( value < size ) {
                throw new ArgumentOutOfRangeException( "MessageCapacityTooSmall" );
            }
    ...
    {
        if ( count > size ) {
            throw new ArgumentOutOfRangeException( "MessageReadCountTooLarge" );
        }
